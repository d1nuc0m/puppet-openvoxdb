...
class openvoxdb (
  ...
  $ssl_dir                                 = $openvoxdb::params::ssl_dir,
  $ssl_set_cert_paths                      = $openvoxdb::params::ssl_set_cert_paths,
  ...
  $ssl_deploy_certs                        = $openvoxdb::params::ssl_deploy_certs,
  ...
  $postgresql_ssl_folder                   = $openvoxdb::params::postgresql_ssl_folder,
  ...
  $manage_dbserver                         = $openvoxdb::params::manage_dbserver,
  ...
  $database_listen_address                 = $openvoxdb::params::postgres_listen_addresses,
